...
const formSchema = z.object({
  ...
  produto: z.string().min(2, "Produto/Serviço deve ter pelo menos 2 caracteres"),
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-sm font-medium">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>Defina sua margem de lucro (%) — esse valor será aplicado<br />sobre o preço base para calcular o valor final do orçamento.</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </FormLabel>
                    ...
                    <FormDescription>
                      Defina sua margem de lucro (%) — esse valor será aplicado sobre o preço base para calcular o valor final do orçamento.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-2 text-sm font-medium">
                      ...
                      <TooltipProvider>
                        <Tooltip>
                          ...
                          <TooltipContent>
                            <p>Use este campo para informar detalhes importantes,<br />como o custo de materiais ou especificações do serviço.</p>
                          </TooltipContent>
                        </Tooltip>
                      </TooltipProvider>
                    </FormLabel>
                    ...
                    <FormDescription>
                      Use este campo para informar detalhes importantes, como o custo de materiais ou especificações do serviço. Quanto mais informações você fornecer, mais preciso será o orçamento.
                    </FormDescription>
                    <FormMessage />
                  </FormItem>
                )}
